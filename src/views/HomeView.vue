<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">0xGen</h1>
      <div class="py-2">
        <h1
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="https://i.postimg.cc/GtzTc51g/f236b5f2-55c6-4fc2-9961-d2f5e9ffb902.jpg">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Web Developer", "Back-end Engineer", "Web3 Enthusiast", "Community Moderator", "Blockchain Ambassador", "DApp Tester", "Crypto Researcher"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
